...
<div class="admin-container">
    ...
    <main class="admin-main">
        ...
        <div class="af-page-header">
            <h1>Edit Supplier</h1>
            <p>Editing supplier <strong>{{ $supplier->brand }}</strong></p>
        </div>
            ...
            <div class="af-card">
                ...
                <div class="af-grid-2">
                    ...
                    <div class="af-field af-span-2">
                        ...
                        <textarea name="address" class="af-textarea" rows="3"
                            placeholder="Street, City, Province, ZIP">{{ old('address', $supplier->address) }}</textarea>
                    </div>
                </div>
            </div>
