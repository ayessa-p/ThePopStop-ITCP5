...
<head>
    <meta charset="UTF-8">
    <title>Purchase Order Status Updated</title>
</head>
<body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; margin: 0; padding: 0; background-color: #f4f4f4;">
    <div style="max-width: 600px; margin: 20px auto; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
        ...
        <div style="padding: 30px; color: #333333;">
            <h2 style="color: #8B0000; margin-top: 0;">Purchase Order Status Updated</h2>
            <p style="margin-bottom: 5px;">Hello,</p>
            <p style="margin-top: 0;">The status of your purchase order <strong>#{{ $purchaseOrder->id }}</strong> has been updated to <strong>{{ $purchaseOrder->status }}</strong>.</p>
            ...
            <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
                ...
                <tbody>
                    ...
                    <tr style="border-bottom: 1px solid #F3F1EA;">
                        ...
                        <td style="padding: 10px; text-align: right; font-size: 14px;">&#8369;{{ number_format($item->unit_cost, 2) }}</td>
                        <td style="padding: 10px; text-align: right; font-size: 14px;">&#8369;{{ number_format($item->quantity * $item->unit_cost, 2) }}</td>
                    </tr>
                    @endforeach
                </tbody>
                <tfoot>
                    <tr>
                        ...
                        <td style="padding: 10px 10px 10px; text-align: right; font-weight: bold; font-size: 16px; color: #8B0000;">₱{{ number_format($purchaseOrder->total_cost, 2) }}</td>
                    </tr>
                </tfoot>
            </table>

            <p style="font-size: 14px; margin-bottom: 5px;">Thank you for your business!</p>
        </div>
